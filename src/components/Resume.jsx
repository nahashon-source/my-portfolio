...
import { timelineItems } from '../data/resume'; // Ensure the path is correct
    ...
    <section id="resume" className="py-20 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
            A snapshot of my academic journey, industry experience, and achievements in technology and software development.
          </p>

          {/* Download Resume Button */}
          <a
            href="/cv/NASHON RESUME 2025.pdf" // ✅ place your CV inside /public/cv/
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors shadow-md"
          >
            <Download size={20} className="mr-2" />
            View Resume
          </a>
        ...
        <div className="max-w-3xl mx-auto">
          {timelineItems.map((item, index) => {
            ...
            return (
              ...
              >
                {/* Timeline Icon */}
                <div className="absolute left-[-11px] p-2 bg-white dark:bg-gray-800 rounded-full border-2 border-green-200 dark:border-gray-700 shadow-sm">
                  <Icon className="text-green-600 w-5 h-5" aria-label="timeline-icon" />
                </div>
